...
public class UserRestController {
	...
	// ismi aranılan kişilerin listesini getirir ama aynı isimde kişi olmasına izin
	// verilmez
	...
	// sayfadan alınan user nesnesinin burada kayıt işlemi yapılıyor. problem oluşma
	// ihtimaline karşı binding result
	// kullanılıyor. hata oluşursa hata mesajı verebilecek şekilde. gerçi bende
	// vermiyor ama
